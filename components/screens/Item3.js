...
const eventData = [
  {
    ...
    title: 'Resort A',
    rating: 4.9,
    image: require('../../Images/Item/item9.jpg'),
    duration: '20-35 min',
    price: 'Rs. 1200000.00',
  },
  {
    ...
    title: 'Resort B',
    rating: 3.8,
    image: require('../../Images/Item/item10.jpg'),
    duration: '35-55 min',
    price: 'Rs. 110000.00',
  },
  {
    ...
    title: 'Resort C',
    rating: 4.0,
    image: require('../../Images/Item/item11.jpg'),
    duration: '35-55 min',
    price: 'Rs. 180000.00',
  },
  {
    ...
    title: 'Resort D',
    rating: 4.5,
    image: require('../../Images/Item/item12.jpg'),
    duration: '35-55 min',
    price: 'Rs. 1000000.00',
  },
...
export default function Item1() {
  ...
  const [vendor, setVendor] = useState('Resort');
  const [vendorType, setVendorType] = useState('Resort');
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.navBar}>
        ...
        <Text style={styles.navTitle}>Resorts</Text>
      </View>
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={styles.row}>
              ...
              >
                <Picker.Item label="Alsvin Resort" value="Alsvin Resort" />
                <Picker.Item label="Dad's Resort" value="Dad's Resort" />
              </Picker>
              <Picker
              ...
              >
                <Picker.Item label="Resorts" value="Resorts" />
              </Picker>
            </View>
