...
const eventData = [
  {
    ...
    title: 'Restaurant A',
    rating: 4.9,
    image: require('../../Images/Item/item13.jpg'),
    duration: '4 hours',
    price: 'Rs. 170000.00',
  },
  {
    ...
    title: 'Restaurant B',
    rating: 3.8,
    image: require('../../Images/Item/item14.jpg'),
    duration: '2 hours',
    price: 'Rs. 110000.00',
  },
  {
    ...
    title: 'Restaurant C',
    rating: 4.0,
    image: require('../../Images/Item/item15.jpg'),
    duration: '3.5 hours',
    price: 'Rs. 105000.00',
  },
  {
    ...
    title: 'Restaurant D',
    rating: 4.0,
    image: require('../../Images/Item/item16.jpg'),
    duration: '3 hours',
    price: 'Rs. 100000.00',
  },
...
export default function Item1() {
  ...
  const [vendor, setVendor] = useState('Restaurant');
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.navBar}>
        ...
        <Text style={styles.navTitle}>Restaurants</Text>
      </View>
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={styles.row}>
              ...
              >
                <Picker.Item label="Pawan Bhai" value="Pawan Bhai" />
                <Picker.Item label="Moody Meal" value="Moody Meal" />
              </Picker>
              <Picker
